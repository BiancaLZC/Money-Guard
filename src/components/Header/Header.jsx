...
import { selectIsLoggedIn, useSelector } from '../../redux/Auth/selectors';
        ...
        <header className={s.header}>
            <div className={s.container}>
                <Link to="/" className={s.icon_wrap}>
                    {isMobile ? <Icon id="#icon-logo_mobile" className={s.icon_mob}></Icon> : <Icon id="icon-logo_tab_desk" className={s.icon_tab_desk}></Icon>}</Link>
